var rough = function() {
    ...
    class o extends n {
        fillPolygons(t, e) {
            ...
            return s.ops = s.ops.concat(a.ops),
            s
        }
    }
    class h {
    ...
    function k(t, e, s, n, a, o, h, r, i, c) {
        ...
        if (Math.abs(y) > 120 * Math.PI / 180) {
            ...
            p = k(s = g + a * Math.cos(d), n = b + o * Math.sin(d), e, r, a, o, h, 0, i, [d, t, g, b])
        }
        y = d - f;
        const m = Math.cos(f)
          , w = Math.sin(f)
    ...
    function T(t) {
        return t.randomizer || (t.randomizer = new l(t.seed || 0)),
        t.randomizer.next()
    }
    ...
    function W(t, e, s) {
        ...
        if (n > 3) {
            ...
            for (let e = 1; e + 2 < n; e++) {
                const s = t[e];
                o[0] = [s[0], s[1]],
                o[1] = [s[0] + (h * t[e + 1][0] - h * t[e - 1][0]) / 6, s[1] + (h * t[e + 1][1] - h * t[e - 1][1]) / 6],
                o[2] = [t[e + 1][0] + (h * t[e][0] - h * t[e + 2][0]) / 6, t[e + 1][1] + (h * t[e][1] - h * t[e + 2][1]) / 6],
                o[3] = [t[e + 1][0], t[e + 1][1]],
                a.push({
                    op: "bcurveTo",
    ...
    function z(t, e, s, n, a, o, h, r) {
        ...
        if (0 === r.roughness) {
            ...
            c.push([A(o, r) + e + n * Math.cos(l + 2 * Math.PI + .5 * h), A(o, r) + s + a * Math.sin(l + 2 * Math.PI + .5 * h)]),
            c.push([A(o, r) + e + .98 * n * Math.cos(l + h), A(o, r) + s + .98 * a * Math.sin(l + h)]),
            c.push([A(o, r) + e + .9 * n * Math.cos(l + .5 * h), A(o, r) + s + .9 * a * Math.sin(l + .5 * h)])
        }
        return [c, i]
    }
    function E(t, e, s, n, a, o, h, r, i) {
        ...
        return l.push([e + n * Math.cos(h), s + a * Math.sin(h)]),
    ...
    function Z(t, e, s, n, a) {
        ...
        return Math.sqrt(i) > n ? (Z(t, e, c + 1, n, o),
        Z(t, c, s, n, o)) : (o.length || o.push(h),
        o.push(r)),
        o
    }
    function Q(t, e=.15, s) {
    ...
    class N {
        ...
        rectangle(t, e, s, n, a) {
            ...
            return o.stroke !== H && h.push(r),
            this._d("rectangle", h, o)
        }
        ellipse(t, e, s, n, a) {
            const o = this._o(a)
              , h = []
            ...
            if (o.fill)
                if ("solid" === o.fillStyle) {
                    ...
                    h.push(L([i.estimatedPoints], o));
            return o.stroke !== H && h.push(i.opset),
            this._d("ellipse", h, o)
        }
        circle(t, e, s, n) {
            ...
            if (h && i.fill)
                if ("solid" === i.fillStyle) {
                    ...
                    c.push(function(t, e, s, n, a, o, h) {
                        ...
                        return d.push([r + c * Math.cos(p), i + l * Math.sin(p)]),
                        d.push([r, i]),
                        L([d], h)
                    }(t, e, s, n, a, o, i));
            return i.stroke !== H && c.push(l),
            this._d("arc", c, i)
        }
        curve(t, e) {
            const s = this._o(e)
            ...
            if (s.fill && s.fill !== H && t.length >= 3) {
                const e = Q(function(t, e=0) {
                    ...
                    const n = [];
                    if (3 === s)
                        n.push(G(t[0]), G(t[1]), G(t[2]), G(t[2]));
                    else {
                        const s = [];
                        s.push(t[0], t[0]);
                        ...
                        for (let t = 1; t + 2 < s.length; t++) {
                            const e = s[t];
                            a[0] = [e[0], e[1]],
                            a[1] = [e[0] + (o * s[t + 1][0] - o * s[t - 1][0]) / 6, e[1] + (o * s[t + 1][1] - o * s[t - 1][1]) / 6],
                            a[2] = [s[t + 1][0] + (o * s[t][0] - o * s[t + 2][0]) / 6, s[t + 1][1] + (o * s[t][1] - o * s[t + 2][1]) / 6],
                            a[3] = [s[t + 1][0], s[t + 1][1]],
                            n.push(a[1], a[2], a[3])
                        }
                    }
        ...
        polygon(t, e) {
            const s = this._o(e)
              , n = []
              , a = m(t, !0, s);
            return s.fill && ("solid" === s.fillStyle ? n.push(S([t], s)) : n.push(L([t], s))),
            s.stroke !== H && n.push(a),
            this._d("polygon", n, s)
        }
        path(t, e) {
            ...
            return a && ("solid" === s.fillStyle ? n.push(S(r, s)) : n.push(L(r, s))),
            o && (h ? r.forEach((t=>{
                n.push(m(t, !1, s))
            }
            )) : n.push(function(t, e) {
    ...
    class K {
        ...
        draw(t) {
            ...
            for (const h of e) {
                ...
                case "path":
                    ...
                    s.strokeLineDash && e.setAttribute("stroke-dasharray", s.strokeLineDash.join(" ").trim()),
                    s.strokeLineDashOffset && e.setAttribute("stroke-dashoffset", `${s.strokeLineDashOffset}`);
                    break;
                case "fillPath":
                    e = n.createElementNS(J, "path"),
                    e.setAttribute("d", this.opsToPath(h, o)),
                    ...
                    "curve" !== t.shape && "polygon" !== t.shape || e.setAttribute("fill-rule", "evenodd");
                    break;
                case "fillSketch":
        ...
        fillSketch(t, e, s) {
            ...
            return a.setAttribute("d", this.opsToPath(e, s.fixedDecimalPlaceDigits)),
