    ...
    useEffect(() => {
        ...
        const onMouseMove = (e) => {
            ...
            if (
                ...
                canvasInfo.stauts = statusConfig.MOVING
                canvasInfo.offsetMouseEvtPos = getMousePosition(e)
            } else if (canvasInfo.stauts === statusConfig.MOVING) {
        ...
        const onMouseUp = (e) => {
            ...
            if (canvasInfo.status === statusConfig.DRAGGING || canvasInfo.stauts === statusConfig.MOVING) {
